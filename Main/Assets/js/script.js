...
document.getElementById("submitButton").addEventListener("click", function () {
  ...
  // const highlightedPrimesCount = pascalsTriangle.reduce((count, row) => {
  //     return count + row.filter((num) => primeNumbers.includes(num)).length;
  // }, 0);

  // const errorRatio = ((primeNumbers.length - highlightedPrimesCount) / primeNumbers.length) * 100;
  // const formattedErrorRatio = errorRatio.toFixed(2);
