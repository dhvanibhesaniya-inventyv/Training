...
fn main() {
    ...
    let content = fs::read_to_string("./Json_files/StudentData.json").expect("Failed to read file");
    ...
    fs::write("./Json_files/StudentData_3.json",updated_json).expect("Failed to write file");
}
