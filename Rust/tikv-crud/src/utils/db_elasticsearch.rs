...
// pub async fn search_students() -> Result<String, String> {
...
//     let json_string = match serde_json::to_string(&response_body) {
//         Ok(string) => string,
//         Err(err) => return Err(format!("Failed to serialize response body: {}", err)),
//     };
...
//     // Extract source data from each hit
...
//     let json_string = match serde_json::to_string(&sources) {
//         Ok(string) => string,
//         Err(err) => return Err(format!("Failed to serialize source data: {}", err)),
//     };
...
pub async fn dynamic_query_builder(
    ...
    // Add must_not caluse if provided
       ...
       // Add must_not clause if provided
